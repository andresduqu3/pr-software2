 ...
 * @Autor Samuel
 */
public class Create_Cassandra extends javax.swing.JInternalFrame {
    ...
    public Create_Cassandra() {
        initComponents();
    }

    public Create_Cassandra(JDesktopPane desktopPane) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ...
            try{
                ...
                MC.CreatePersona(identidad, nombre, telefono, carrera, promedio, genero, libro);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Create_Cassandra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Create_Cassandra().setVisible(true);
            }
        });
    }
