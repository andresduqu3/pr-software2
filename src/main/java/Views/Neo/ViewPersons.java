...
public class ViewPersons extends javax.swing.JInternalFrame {
    ...
    public ViewPersons(JDesktopPane desktopPane) {
        initComponents();
        
        this.desktopPane = desktopPane;
        var persons = controlador.getPersons();

        DefaultTableModel model = (DefaultTableModel) table.getModel();

        model.setRowCount(0); // reset model

        Object rowData[] = new Object[persons.size()];

         for(PersonDTO m: persons){
            rowData[0] = m.getName()+"";
            rowData[1] = m.getBorn()+"";
