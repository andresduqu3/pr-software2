...
public class ViewInsert extends javax.swing.JInternalFrame {
    ...
    public ViewInsert(JDesktopPane desktopPane) {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Insertar Neo4J");
        ...
        jLabel9.setText("Relaciones");

        jLabel10.setText("ACTED IN");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (this.jTextField3.getText().equals("") || this.jTextField4.getText().equals("") || this.jTextField5.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Campos sin llenar");

        } else {
            String title = jTextField3.getText();
            int released = Integer.parseInt(jTextField4.getText());
            String tagline = jTextField5.getText();
            
            // Create Movie
            var e = ctrl.createMovie(title, released, tagline);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (this.jTextField1.getText().equals("") || this.jTextField2.getText().equals("")) {
            ...
            int born = Integer.parseInt(jTextField2.getText());

            // Create Person
            var f = ctrl.createPerson(name, born);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        // 7 Person / actor
        // 8 properties
        if (this.jTextField6.getText().equals("") || this.jTextField7.getText().equals("") || this.jTextField8.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Campos sin llenar");

        } else {
            String actor = jTextField7.getText();
            String movie = jTextField6.getText();
            String roles = jTextField8.getText();
            
            System.out.println(actor);
            
            Map<String, List<String>> list = new HashMap<>();
            list.put("roles", Arrays.asList(roles.split(",")));
        
            ctrl.createRelationACTED_IN(actor, movie, list);
