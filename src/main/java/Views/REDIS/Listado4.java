...
public class Listado4 extends javax.swing.JInternalFrame {
    ...
    public Listado4(JDesktopPane desktopPane) {
        initComponents();
    }
    ...
    private void btn_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_buscarActionPerformed
        ...
        controlador.conectarREDIS();
        reporte = controlador.listarEmpleadoSalarioREDIS(Double.parseDouble(textano.getText()));
        controlador.desconectarREDIS();
