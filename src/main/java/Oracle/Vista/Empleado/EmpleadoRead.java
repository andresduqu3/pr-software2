 ...
 * @Autor Samuel
 */
public class EmpleadoRead extends javax.swing.JInternalFrame {
    private int vent = 0;
   ...
   public EmpleadoRead(JDesktopPane desktopPane) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmpleadoRead.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmpleadoRead().setVisible(true);
            }
        });
    }
