 ...
 * @Autor Samuel
 */
public class CargoRead extends javax.swing.JInternalFrame {
    private int vent = 0;
    ...
    public CargoRead(JDesktopPane desktopPane) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CargoRead.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
