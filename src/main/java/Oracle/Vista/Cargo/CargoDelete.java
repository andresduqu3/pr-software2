 ...
 * @Autor Samuel
 */
public class CargoDelete extends javax.swing.JInternalFrame {
    private int vent = 0;
    ...
    public CargoDelete(JDesktopPane desktopPane) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (SingletonMaster.getInstance(vent) == null){
            ...
            GUI.masterCargo.BorrarCargo(vent, aux);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CargoDelete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CargoDelete().setVisible(true);
            }
        });
    }
