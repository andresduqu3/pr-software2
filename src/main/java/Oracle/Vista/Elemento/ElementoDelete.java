 ...
 * @Autor Samuel
 */
public class ElementoDelete extends javax.swing.JInternalFrame {
    private int vent = 0;
    JDesktopPane desktopPane;
    /**
     * Creates new form EmpleadoDelete
     */
    public ElementoDelete() {
        initComponents();
    ...
    public ElementoDelete(JDesktopPane desktopPane) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (SingletonMaster.getInstance(vent) == null){
            ...
            GUI.masterElemento.BorrarElemento(vent, aux);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ElementoDelete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ElementoDelete().setVisible(true);
            }
        });
    }
