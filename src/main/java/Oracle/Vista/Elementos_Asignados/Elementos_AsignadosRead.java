 ...
 * @Autor Samuel
 */
public class Elementos_AsignadosRead extends javax.swing.JInternalFrame {
    private int vent = 0;
    JDesktopPane desktopPane;
    /**
     * Creates new form EmpleadoRead
     */
    public Elementos_AsignadosRead() {
        initComponents();
    ...
    public Elementos_AsignadosRead(JDesktopPane desktopPane) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Elementos Asignados");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Elementos_AsignadosRead.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Elementos_AsignadosRead().setVisible(true);
            }
        });
    }
