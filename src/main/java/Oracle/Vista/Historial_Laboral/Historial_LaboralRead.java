 ...
 * @Autor Samuel
 */
public class Historial_LaboralRead extends javax.swing.JInternalFrame {
    private int vent = 0;
    JDesktopPane desktopPane;
    /**
     * Creates new form EmpleadoRead
     */
    public Historial_LaboralRead() {
        initComponents();
    ...
    public Historial_LaboralRead(JDesktopPane desktopPane) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Historial_LaboralRead.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Historial_LaboralRead().setVisible(true);
            }
        });
    }
