...
public class DTO_Elemento {
    ...
    public DTO_Elemento(Double codigo, String elemento, String devolutivo, String talla, String uso, String materiales, String mantenimiento, String usos, String norma, String atenuacion, String serial, String tallas, int unidad, String ruta, int vida_util, int precio_actual, int cantidad_elementos) {
        this.codigo = codigo;
